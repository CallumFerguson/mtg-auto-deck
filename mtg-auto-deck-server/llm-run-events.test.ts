...
test("summarizes latest benchmark evaluations only", () => {
  const targetRuns = [
    ...
    {
      deckId: "deck-5",
      simulationId: "simulation-5",
      targetLlmRunId: "target-6",
      targetRunPhase: "turn" as const,
      turnNumber: 4,
    },
  ]
      ...
      latestEvaluations: [
        {
          ...
          simulationQualityScoreReasoning: "Issue text did not fail the run.",
          status: "completed",
          strategicPass: true,
          strategicMistakes: [],
          targetLlmRunId: "target-3",
        ...
        },
        {
          ...
          simulationQualityScoreReasoning: "Missed a lethal attack.",
          status: "completed",
          strategicPass: false,
          strategicMistakes: ["Did not attack for lethal."],
          targetLlmRunId: "target-6",
        },
        {
          attemptNumber: 1,
        ...
        },
        {
          ...
          legalPass: null,
          resultStatus: "failed",
          resultFailureMessage: "Could not parse evaluation response.",
          simulationQualityScore: null,
          simulationQualityScoreReasoning: null,
          status: "completed",
          strategicPass: null,
